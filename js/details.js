...
function getDetails()
    ...
    if (dataset == 'permit') { 
      ...
      $.ajax({
          ...
          $("#record").append('<div id="content" class="col-md-4"><h1>' + AddressClean(property.Address) + '</h1><h3>Permit</h3><ul class="permit"><li><b>Permit ID:</b> ' + property.PermitID + '</li><li><b>Date:</b> ' + FormatDate(property.DateCreated) + '</li><li><b>Address:</b> ' + AddressProper(property.Address) + '</li>  <li><b>Permit Type:</b> ' + ProperCase(property.PermitType) + '</li><li><b>Construction Cost: </b>' + FormatCurrency(property.ConstructionCost) + '</li><li><b>Contractor:</b> ' + ProperCase(property.Contractor) + '</li><li><b>Status:</b> ' + ProperCase(property.Status) + '</li><li><b>StatusDate:</b> ' + formatDate(property.StatusDate) + '</li></ul></div>')    
