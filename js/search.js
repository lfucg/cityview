...
$.ajax({
    ...
    success: function(data) {
      ...
      $("#tablebody").append('<tr><td>' + FormatDate(property.Date) + '</td><td>' + AddressClean(property.Address) + ' '+ ProperCase(property.Suite) + '</td><td>' + ProperCase(property.PermitType) + '</td><td>' + FormatCurrency(property.ConstructionCost) + '</td><td><a href="details.html?type=permit&ID=' + property._id +'">View Permit</a></td></tr>')});     
    }
  });
};
