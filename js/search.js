...
$.ajax({
    ...
    success: function(data) {
      ...
      $("#tablebody").append('<tr><td>' + FormatDate(property.Date) + '</td><td>' + AddressClean(property.Address) + ' '+ ProperCase(property.Suite) + '</td><td>' + ProperCase(property.PermitType) + '</td><td>' + FormatCurrency(property.ConstructionCost) + '</td><td>' + ProperCase(property.OwnerName) + '</td><td>' + ProperCase(property.Contractor) + '</td><td><a href="details.html?type=permit&ID=' + property._id +'">View Permit</a></td></tr>')});     
    }
  });
};
